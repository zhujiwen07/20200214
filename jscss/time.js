function showTime() { 
	...
	var startDate = new Date(2018, 01, 03);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear BoBo:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----zhujiwen   2020-02-14</c>"; 
